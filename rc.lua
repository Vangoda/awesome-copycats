...
if awesome.startup_errors then
    naughty.notify {
        ...
        title = "Whoops! Seems you fucked up :D",
...
run_once({
    "unclutter -root",
    -- KB layout switch
    "setxkbmap -layout 'us,hr' -option 'grp:ctrl_space_toggle'",
    -- Clipboard manager
    "copyq",
...
-- Custom autostart for sh scripts.
...
lain.layout.cascade.tile.offset_x = 1
lain.layout.cascade.tile.offset_y = 12
lain.layout.cascade.tile.extra_padding = 1
...
-- Load colorscheme
awful.spawn.with_shell("xrdb -merge $HOME/.colors/powerarrow-vangoda")
-- Generate alacritty config from colorscheme
awful.spawn.with_shell("$HOME/.colors/convert-colorscheme.sh")
...
local clientbuttons = mytable.join(awful.button({}, 1, function(c)
